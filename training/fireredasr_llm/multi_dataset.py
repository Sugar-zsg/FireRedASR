...
class MultiDataset:
    ...
    def test_dataset_train_cuts(self) -> CutSet:
        """Load synthetic test dataset for quick testing"""
        logging.info("Loading synthetic test dataset (train)")
        return load_manifest_lazy(self.fbank_dir / "test_dataset" / "test_cuts_train.jsonl.gz")

    def test_dataset_dev_cuts(self) -> CutSet:
        """Load synthetic test dataset for quick testing"""
        logging.info("Loading synthetic test dataset (dev)")
        return load_manifest_lazy(self.fbank_dir / "test_dataset" / "test_cuts_dev.jsonl.gz")

    def test_dataset_test_cuts(self) -> CutSet:
        """Load synthetic test dataset for quick testing"""
